            ...
            <div v-if="form_state" class="login-box">
                <form>
                    ...
                    <div class="login-form-box">
                        ...
                        <input placeholder="Correo" type="email" id="email-login">

                        <label for="password-login">Contraseña</label>
                        <input placeholder="Contraseña" type="password" id="password-login">
            ...
            <div v-else class="signup-box">
                <form>
                    ...
                    <div class="signup-form-box">
                        ...
                        <input placeholder="Correo" type="email" id="email-signup">

                        <label for="password-signup">Contraseña</label>
                        <input placeholder="Contraseña" type="password" id="password-signup">
